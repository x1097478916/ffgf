...
import java.util.*;
	import java.text.*;
public class ChinaMobileUserCallRecordLinkedList extends PhoneUserCallRecordLinkedList {
	
			 
			 public  ChinaMobileUserCallRecordLinkedList () {
			 ...
			 public void printDetails() {
				 DateFormat d=DateFormat.getDateTimeInstance(DateFormat.MEDIUM,DateFormat.MEDIUM);Iterator ia=al.iterator();
					while(ia.hasNext()) {
